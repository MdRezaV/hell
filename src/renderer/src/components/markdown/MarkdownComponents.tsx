import React, { Children, isValidElement, memo, type ReactNode } from 'react'
import type { Components } from 'react-markdown'
import ReactMarkdown from 'react-markdown'
import remarkGfm from 'remark-gfm'
import remarkBreaks from 'remark-breaks'
import { extractText } from '../../utils/markdownHelpers'
import { parseReplaceBlock } from '../../utils/markdownParser'
import { FileIncludeAddButton } from './MarkdownPrimitives'
import { CommandBlock, CommitBlock, GenericCodeBlock, TaskBlock } from './SpecialBlocks'
...
import {
  ...
  FileMoveBlock,
  FileReplaceBlock
} from '@renderer/components/markdown/FileBlocks'
